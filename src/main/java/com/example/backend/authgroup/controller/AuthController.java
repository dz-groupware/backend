...
//        return new ResponseEntity(new MultiResponseDto(authService.findAuthList(companyId, pageNumber, pageSize), new PageDto(pageNumber, pageSize, authService.getTotalElements())), HttpStatus.OK);
//    }
//}
